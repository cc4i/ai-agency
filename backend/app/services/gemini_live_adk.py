...
- Present the 4 image options generated by the Art Director.
...
- When user selects (e.g., "I choose the fourth one"), call `update_project_brief` with `selected_image_variation` immediately.
  - "first one" → selected_image_variation=1
  - "second one" → selected_image_variation=2
  - "third one" → selected_image_variation=3
  - "fourth one" → selected_image_variation=4
...
5. **User selects an image** → `update_project_brief` with `selected_image_variation=<1-4>`
   - "I choose the first one" → `update_project_brief(selected_image_variation=1)`
   - "I choose the fourth one" → `update_project_brief(selected_image_variation=4)`
